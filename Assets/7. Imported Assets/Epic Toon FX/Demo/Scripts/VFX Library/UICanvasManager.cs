...
public class UICanvasManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.A)) SelectPreviousPE();
        if (Input.GetKeyUp(KeyCode.D)) SelectNextPE();
    }
    ...
    public void UpdateToolTip(ButtonTypes toolTipType)
    {
        if (ToolTipText != null)
        {
            ...
            else if (toolTipType == ButtonTypes.Next) ToolTipText.text = "Select Next Particle Effect";
        }
    }
