...
namespace ToonyColorsPro
{
    namespace Demo
    {
        public class TCP2_Demo_Cat : MonoBehaviour
        {
            ...
            {
                var isCat = !unityChanCopyright.activeInHierarchy;
                float currentTime;
                if (isCat)
                {
            ...
            public void SetAnimation(int index)
            {
                ...
                foreach (var anim in catAnimation) anim.clip = catAnimations[index];
                ...
                foreach (var anim in unityChanAnimation) anim.clip = unityChanAnimations[index];
            ...
            {
                var isCat = !unityChanCopyright.activeInHierarchy;
                var isFlat = flatGroup.activeSelf;
                if (isCat)
                {
