    ...
    namespace Demo
    {
        public class TCP2_Demo_View : MonoBehaviour
        {
            ...
            private void Update()
            {
                ...
                if (!mMouseDown)
                    mMouseDown = Input.GetMouseButtonDown(0) && !new Rect(0, 65, 230, 260).Contains(Input.mousePosition)
                        ? true
                        : false;
                else
                ...
                //Keyboard support
                orbitAcceleration.y +=
                    Input.GetKey(KeyCode.LeftArrow) ? 15 : Input.GetKey(KeyCode.RightArrow) ? -15 : 0;
