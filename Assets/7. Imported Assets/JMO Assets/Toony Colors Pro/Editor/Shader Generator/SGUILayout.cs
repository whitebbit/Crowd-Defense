...
namespace ToonyColorsPro
{
    namespace ShaderGenerator
    {
        internal static class SGUILayout
        {
            ...
            private static readonly string RGBAOptions = "RGBA";

            private static readonly string XYZWOptions = "XYZW";

            private static readonly GUIContent gcInspectorLock = EditorGUIUtility.IconContent("InspectorLock");
            ...
            public static char GenericSelector(string options, char current, float buttonWidth = 25)
            {
                ...
                {
                    var rect = GUILayoutUtility.GetRect(GUIContent.none, TCP2_GUI.ShurikenMiniButton,
                        GUILayout.Height(15), GUILayout.Width(w));
                    rect.height = 12;
                    ...
                    if (options.Length == 2)
                        ...
                        style = i == 0 ? TCP2_GUI.ShurikenMiniButtonLeft :
                            i == options.Length - 1 ? TCP2_GUI.ShurikenMiniButtonRight : TCP2_GUI.ShurikenMiniButtonMid;
            ...
            public static string GenericSwizzle(string selected, int channelsCount, string options, float width = 50,
                bool showAvailableChannels = true)
            {
                EditorGUI.BeginChangeCheck();
                var newSelected =
                    EditorGUILayout.DelayedTextField(selected, Styles.ShurikenValue, GUILayout.Width(width));
                if (EditorGUI.EndChangeCheck())
                {
                    // not enough characters
                    if (newSelected.Length < channelsCount) return selected;

                    // remove extra characters
                    if (newSelected.Length > channelsCount) newSelected = newSelected.Substring(0, channelsCount);
            ...
            public static bool Foldout(bool foldout, GUIContent label, bool highlighted = false, float width = 130)
            {
                ...
                var rect = GUILayoutUtility.GetRect(label,
                    highlighted ? Styles.GrayMiniFoldoutHighlighted : Styles.GrayMiniFoldout, GUILayout.Height(13),
                    GUILayout.Width(width));
                return EditorGUI.Foldout(rect, foldout, label, true,
                    highlighted ? Styles.GrayMiniFoldoutHighlighted : Styles.GrayMiniFoldout);
            }
            ...
            public static void InlineLabel(GUIContent label, bool highlight = false, float width = 130)
            {
                GUILayout.Space(Indent);
                var rect = GUILayoutUtility.GetRect(label,
                    highlight ? Styles.GrayMiniLabelHighlighted : Styles.GrayMiniLabel, GUILayout.Height(13),
                    GUILayout.Width(width));
            ...
            {
                return EditorGUILayout.EnumPopup(enm, Styles.ShurikenPopup, GUILayout.MinWidth(248));
            }

            public static int Popup(int index, string[] values)
            {
                return EditorGUILayout.Popup(index, values, Styles.ShurikenPopup, GUILayout.MinWidth(248));
            }

            public static string TextField(string str, bool delayed = false)
            {
                if (delayed)
                    return EditorGUILayout.DelayedTextField(GUIContent.none, str, Styles.ShurikenValue,
                        GUILayout.MinWidth(248));
            ...
            public static string TextFieldShaderVariable(string str)
            {
                ...
                var authChars =
                    new List<char>("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_0123456789".ToCharArray());
            ...
            public static T ObjectField<T>(T obj) where T : Object
            {
                ...
                return (T)EditorGUILayout.ObjectField(GUIContent.none, obj, typeof(T), false, GUILayout.MinWidth(248),
                    GUILayout.Height(13));
            }

            public static T DrawProObjectField<T>(T obj, params GUILayoutOption[] options) where T : Object
            {
                var pickerID = "ShurikenObjectField".GetHashCode();
                ...
                GUI.Label(rect, TCP2_GUI.TempContent(obj != null ? obj.name : "None (" + typeof(T) + ")"),
                    Styles.ShurikenValue);
            ...
            {
                return GUILayout.Button(label, Styles.ShurikenPopup, GUILayout.MinWidth(248), GUILayout.MinHeight(16));
            }

            public static int IntField(int value)
            {
                return EditorGUILayout.IntField(value, Styles.ShurikenValue);
            }

            public static int IntField(int value, int min, int max)
            {
                return Mathf.Clamp(EditorGUILayout.IntField(value, Styles.ShurikenValue), min, max);
            }

            public static float FloatField(float value)
            {
                return EditorGUILayout.FloatField(value, Styles.ShurikenValue);
            }

            public static Vector2 Vector2Field(Vector2 v2)
            {
                return VectorFieldCustomStyle(v2, 2);
            }

            public static Vector3 Vector3Field(Vector3 v3)
            {
                return VectorFieldCustomStyle(v3, 3);
            }

            public static Vector4 Vector4Field(Vector4 v4)
            {
                return VectorFieldCustomStyle(v4, 4);
            }
            ...
            private static Vector4 VectorFieldCustomStyle(Vector4 vec, int channels)
            {
            ...
            internal static class Styles
            {
                ...
                private const int shurikenFontSize = 11;
                private static GUIStyle _GrayLabel;

                private static GUIStyle _GrayMiniLabel;

                private static GUIStyle _GrayMiniLabelWrap;

                private static GUIStyle _GrayMiniLabelWrapHighlighted;


                private static GUIStyle _GrayMiniBoldLabel;

                private static GUIStyle _GrayMiniLabelHighlighted;

                private static GUIStyle _GrayMiniFoldout;

                private static GUIStyle _GrayMiniFoldoutHighlighted;

                private static GUIStyle _GrayInlineLabel;

                private static GUIStyle _LineStyle;

                private static GUIStyle _ShurikenValue;

                private static GUIStyle _ShurikenPopup;

                private static GUIStyle _ShurikenToggle;

                private static GUIStyle _ShurikenTextArea;

                private static GUIStyle _ShurikenObjectField;
                    ...
                    get
                    {
                        if (_GrayMiniLabelWrapHighlighted == null)
                        {
                            ...
                            var textColor = EditorGUIUtility.isProSkin
                                ? new Color(0.0f, 0.574f, 0.488f)
                                : new Color(0.03f, 0.46f, 0.4f);
                ...
                internal static GUIStyle GrayInlineLabel
                {
                    get
                    {
                        if (_GrayInlineLabel == null) _GrayInlineLabel = new GUIStyle(GrayLabel);
