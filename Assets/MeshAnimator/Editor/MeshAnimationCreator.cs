...
namespace FSG.MeshAnimator
{
    ...
    {
        private static readonly string version = "2.0.28";
                ...
                if (prefab != null)
                {
                    ...
                    using (RenderSection.Draw("Bake Preferences", bgs[0], () =>
                    {
                        ...
                        if (selectedAnimatorType == MeshAnimatorType.ShaderAnimated)
                        {
                            ...
                            {
                                DrawInformation("Shader graph support requires that the vertex id of the meshes be written to UV data. UV3 will be used and overwrite existing data.");
                            }
                        }
